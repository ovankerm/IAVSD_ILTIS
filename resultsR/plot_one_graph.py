...
InPhase5ms_normal_contact_q = np.loadtxt('InPhaseCosine_5ms_normal_contact_q.res')
InPhase5ms_normal_contact_wheels = np.loadtxt('InPhaseCosine_5ms_normal_contact_Ground_Forces.res')
InPhase5ms_simple_contact_q = np.loadtxt('InPhaseCosine_5ms_simple_contact_q.res')
InPhase5ms_simple_contact_wheels = np.loadtxt('InPhaseCosine_5ms_simple_contact_Ground_Forces.res')

plt.figure("In-phase at 5m/s - Normal contact - Vert. Displ.")
plt.plot(InPhase5ms_normal_contact_q[:, Id_x], (InPhase5ms_normal_contact_q[:, Id_z] - 0.57) * 1000., 'b-', label='Normal contact')
plt.plot(InPhase5ms_simple_contact_q[:, Id_x], (InPhase5ms_simple_contact_q[:, Id_z] - 0.57) * 1000., 'k-', label='Simple contact')
