...
UserModel* mbs_new_user_model() 
{
    ...
    um->Nid_De_Poule.Left = 0.0;
    um->Nid_De_Poule.Right = 0.0;
 ...
 void mbs_load_user_model_xml(MbsInfos* mbs_infos, UserModel* um) 
{
    ...
    um->Nid_De_Poule.Left = mbs_infos->user_models->user_model_list[6]->parameter_list[2]->value_list[1];
    um->Nid_De_Poule.Right = mbs_infos->user_models->user_model_list[6]->parameter_list[3]->value_list[1];
 ...
 void mbs_bind_user_model(MbsInfos* mbs_infos, UserModel* um) 
{
    ...
    mbs_infos->user_models->user_model_list[4]->parameter_list[8]->val_ptr = &um->Status.Bumpy;
    ...
    mbs_infos->user_models->user_model_list[6]->parameter_list[2]->val_ptr = &um->Nid_De_Poule.Left;
    mbs_infos->user_models->user_model_list[6]->parameter_list[3]->val_ptr = &um->Nid_De_Poule.Right;
 ...
 void mbs_print_user_model(UserModel* um) 
{
    ...
    printf("user_model->Nid_De_Poule.Left=%f\n", um->Nid_De_Poule.Left);
    printf("user_model->Nid_De_Poule.Right=%f\n", um->Nid_De_Poule.Right);
