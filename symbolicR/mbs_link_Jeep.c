...
RLlnk2_24 = ROlnk2_59*dpt[2][21]+ROlnk2_89*dpt[3][21];
RLlnk2_34 = ROlnk2_69*dpt[2][21]+ROlnk2_99*dpt[3][21];
POlnk2_14 = dpt[1][21]+dpt[1][2];
...
RLlnk4_22 = dpt[2][48]*C31;
RLlnk4_32 = dpt[2][48]*S31;
...
RLlnk4_23 = ROlnk4_832*dpt[3][49];
RLlnk4_33 = ROlnk4_932*dpt[3][49];
...
RLlnk4_24 = ROlnk4_533*dpt[2][52]+ROlnk4_833*dpt[3][52];
RLlnk4_34 = ROlnk4_633*dpt[2][52]+ROlnk4_933*dpt[3][52];
POlnk4_14 = dpt[1][10]+dpt[1][52];
...
RLlnk6_24 = dpt[2][28]*C14;
RLlnk6_34 = dpt[2][28]*S14;
...
RLlnk6_25 = ROlnk6_817*dpt[3][29];
RLlnk6_35 = ROlnk6_917*dpt[3][29];
...
RLlnk6_26 = ROlnk6_518*dpt[2][32]+ROlnk6_818*dpt[3][32];
RLlnk6_36 = ROlnk6_618*dpt[2][32]+ROlnk6_918*dpt[3][32];
POlnk6_16 = dpt[1][32]+dpt[1][4];
...
RLlnk7_24 = dpt[2][37]*C22;
RLlnk7_34 = dpt[2][37]*S22;
...
RLlnk7_25 = ROlnk7_825*dpt[3][38];
RLlnk7_35 = ROlnk7_925*dpt[3][38];
...
RLlnk7_26 = ROlnk7_526*dpt[2][41]+ROlnk7_826*dpt[3][41];
RLlnk7_36 = ROlnk7_626*dpt[2][41]+ROlnk7_926*dpt[3][41];
POlnk7_16 = dpt[1][41]+dpt[1][7];
...
RLlnk10_22 = dpt[2][17]*C7;
RLlnk10_32 = dpt[2][17]*S7;
...
RLlnk12_24 = dpt[2][28]*C14;
RLlnk12_34 = dpt[2][28]*S14;
...
RLlnk14_22 = dpt[2][48]*C31;
RLlnk14_32 = dpt[2][48]*S31;
...
RLlnk16_24 = dpt[2][37]*C22;
RLlnk16_34 = dpt[2][37]*S22;
...
trqlnk9_1_1 = fSlnk21*dpt[3][21]-fSlnk31*(dpt[2][21]-l[2][9]);
trqlnk9_1_2 = -fSlnk11*dpt[3][21]+fSlnk31*dpt[1][21];
trqlnk9_1_3 = fSlnk11*(dpt[2][21]-l[2][9])-fSlnk21*dpt[1][21];
fPlnk12 = Flink2*e12;
fPlnk22 = Flink2*e22;
fPlnk32 = Flink2*e32;
...
trqlnk33_2_1 = fSlnk22*dpt[3][52]-fSlnk32*(dpt[2][52]-l[2][33]);
trqlnk33_2_2 = -fSlnk12*dpt[3][52]+fSlnk32*dpt[1][52];
trqlnk33_2_3 = fSlnk12*(dpt[2][52]-l[2][33])-fSlnk22*dpt[1][52];
fPlnk13 = Flink3*e13;
fPlnk23 = Flink3*e23;
fPlnk33 = Flink3*e33;
...
trqlnk18_3_1 = fSlnk23*dpt[3][32]-fSlnk33*(dpt[2][32]-l[2][18]);
trqlnk18_3_2 = -fSlnk13*dpt[3][32]+fSlnk33*dpt[1][32];
trqlnk18_3_3 = fSlnk13*(dpt[2][32]-l[2][18])-fSlnk23*dpt[1][32];
fPlnk14 = Flink4*e14;
fPlnk24 = Flink4*(ROlnk7_526*e24+ROlnk7_626*e34);
fPlnk34 = Flink4*(ROlnk7_826*e24+ROlnk7_926*e34);
trqlnk26_4_1 = -fPlnk24*dpt[3][41]+fPlnk34*(dpt[2][41]-l[2][26]);
trqlnk26_4_2 = fPlnk14*dpt[3][41]-fPlnk34*dpt[1][41];
trqlnk26_4_3 = -fPlnk14*(dpt[2][41]-l[2][26])+fPlnk24*dpt[1][41];
fSlnk14 = Flink4*e14;
fSlnk24 = Flink4*e24;
fSlnk34 = Flink4*e34;
...
trqlnk7_5_1 = -fSlnk35*dpt[2][17];
trqlnk7_5_3 = fSlnk15*dpt[2][17];
fPlnk16 = Flink6*e16;
fPlnk26 = Flink6*e26;
fPlnk36 = Flink6*e36;
fSlnk16 = Flink6*e16;
...
trqlnk16_6_1 = -fSlnk36*dpt[2][28];
trqlnk16_6_3 = fSlnk16*dpt[2][28];
fPlnk17 = Flink7*e17;
fPlnk27 = Flink7*e27;
fPlnk37 = Flink7*e37;
fSlnk17 = Flink7*e17;
...
trqlnk31_7_1 = -fSlnk37*dpt[2][48];
trqlnk31_7_3 = fSlnk17*dpt[2][48];
fPlnk18 = Flink8*e18;
fPlnk28 = Flink8*e28;
fPlnk38 = Flink8*e38;
fSlnk18 = Flink8*e18;
...
trqlnk24_8_1 = -fSlnk38*dpt[2][37];
trqlnk24_8_3 = fSlnk18*dpt[2][37];
