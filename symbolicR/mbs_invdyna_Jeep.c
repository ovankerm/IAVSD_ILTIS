...
BETA38 = BS38+OMp28;
BETA68 = BS68-OMp18;
ALPHA18 = ALPHA17+BETA27*dpt[2][17];
ALPHA28 = C8*(ALPHA27+BS57*dpt[2][17])+S8*(ALPHA37+BETA87*dpt[2][17]);
ALPHA38 = C8*(ALPHA37+BETA87*dpt[2][17])-S8*(ALPHA27+BS57*dpt[2][17]);
OM19 = qd[9]+OM18;
...
BETA29 = BS29-OMp39;
BETA89 = BS69+OMp19;
ALPHA19 = ALPHA18+BETA38*dpt[3][18];
ALPHA29 = C9*(ALPHA28+BETA68*dpt[3][18])+S9*(ALPHA38+BS98*dpt[3][18]);
ALPHA39 = C9*(ALPHA38+BS98*dpt[3][18])-S9*(ALPHA28+BETA68*dpt[3][18]);
...
ALPHA110 = C10*(ALPHA18+BETA38*dpt[3][19])+S10*(ALPHA28+BETA68*dpt[3][19]);
ALPHA210 = C10*(ALPHA28+BETA68*dpt[3][19])-S10*(ALPHA18+BETA38*dpt[3][19]);
ALPHA310 = ALPHA38+BS98*dpt[3][19];
OM111 = qd[11]+OM110;
...
ALPHA111 = ALPHA110+BETA310*dpt[3][22];
ALPHA211 = C11*(ALPHA210+BETA610*dpt[3][22])+S11*(ALPHA310+BS910*dpt[3][22]);
ALPHA311 = C11*(ALPHA310+BS910*dpt[3][22])-S11*(ALPHA210+BETA610*dpt[3][22]);
...
ALPHA112 = C12*(ALPHA111+BETA211*dpt[2][24]+BETA311*dpt[3][24])-S12*(ALPHA311+BETA811*dpt[2][24]+BS911*dpt[3][24]);
ALPHA212 = ALPHA211+BETA611*dpt[3][24]+BS511*dpt[2][24];
ALPHA312 = C12*(ALPHA311+BETA811*dpt[2][24]+BS911*dpt[3][24])+S12*(ALPHA111+BETA211*dpt[2][24]+BETA311*dpt[3][24]);
OM114 = qd[14]+OM16;
...
ALPHA117 = ALPHA116+BETA216*dpt[2][28];
ALPHA217 = C17*(ALPHA216+BS516*dpt[2][28])+S17*(ALPHA316+BETA816*dpt[2][28]);
ALPHA317 = C17*(ALPHA316+BETA816*dpt[2][28])-S17*(ALPHA216+BS516*dpt[2][28]);
OM118 = qd[18]+OM117;
...
ALPHA118 = ALPHA117+BETA317*dpt[3][29];
ALPHA218 = C18*(ALPHA217+BETA617*dpt[3][29])+S18*(ALPHA317+BS917*dpt[3][29]);
ALPHA318 = C18*(ALPHA317+BS917*dpt[3][29])-S18*(ALPHA217+BETA617*dpt[3][29]);
...
ALPHA119 = C19*(ALPHA117+BETA317*dpt[3][30])+S19*(ALPHA217+BETA617*dpt[3][30]);
ALPHA219 = C19*(ALPHA217+BETA617*dpt[3][30])-S19*(ALPHA117+BETA317*dpt[3][30]);
ALPHA319 = ALPHA317+BS917*dpt[3][30];
OM120 = qd[20]+OM119;
...
ALPHA120 = ALPHA119+BETA319*dpt[3][33];
ALPHA220 = C20*(ALPHA219+BETA619*dpt[3][33])+S20*(ALPHA319+BS919*dpt[3][33]);
ALPHA320 = C20*(ALPHA319+BS919*dpt[3][33])-S20*(ALPHA219+BETA619*dpt[3][33]);
...
ALPHA121 = C21*(ALPHA120+BETA220*dpt[2][35]+BETA320*dpt[3][35])-S21*(ALPHA320+BETA820*dpt[2][35]+BS920*dpt[3][35]);
ALPHA221 = ALPHA220+BETA620*dpt[3][35]+BS520*dpt[2][35];
ALPHA321 = C21*(ALPHA320+BETA820*dpt[2][35]+BS920*dpt[3][35])+S21*(ALPHA120+BETA220*dpt[2][35]+BETA320*dpt[3][35]);
OM122 = qd[22]+OM16;
...
ALPHA125 = ALPHA124+BETA224*dpt[2][37];
ALPHA225 = C25*(ALPHA224+BS524*dpt[2][37])+S25*(ALPHA324+BETA824*dpt[2][37]);
ALPHA325 = C25*(ALPHA324+BETA824*dpt[2][37])-S25*(ALPHA224+BS524*dpt[2][37]);
OM126 = qd[26]+OM125;
...
ALPHA126 = ALPHA125+BETA325*dpt[3][38];
ALPHA226 = C26*(ALPHA225+BETA625*dpt[3][38])+S26*(ALPHA325+BS925*dpt[3][38]);
ALPHA326 = C26*(ALPHA325+BS925*dpt[3][38])-S26*(ALPHA225+BETA625*dpt[3][38]);
...
ALPHA127 = C27*(ALPHA125+BETA325*dpt[3][39])+S27*(ALPHA225+BETA625*dpt[3][39]);
ALPHA227 = C27*(ALPHA225+BETA625*dpt[3][39])-S27*(ALPHA125+BETA325*dpt[3][39]);
ALPHA327 = ALPHA325+BS925*dpt[3][39];
OM128 = qd[28]+OM127;
...
ALPHA128 = ALPHA127+BETA327*dpt[3][42];
ALPHA228 = C28*(ALPHA227+BETA627*dpt[3][42])+S28*(ALPHA327+BS927*dpt[3][42]);
ALPHA328 = C28*(ALPHA327+BS927*dpt[3][42])-S28*(ALPHA227+BETA627*dpt[3][42]);
...
ALPHA129 = C29*(ALPHA128+BETA228*dpt[2][44]+BETA328*dpt[3][44])-S29*(ALPHA328+BETA828*dpt[2][44]+BS928*dpt[3][44]);
ALPHA229 = ALPHA228+BETA628*dpt[3][44]+BS528*dpt[2][44];
ALPHA329 = C29*(ALPHA328+BETA828*dpt[2][44]+BS928*dpt[3][44])+S29*(ALPHA128+BETA228*dpt[2][44]+BETA328*dpt[3][44]);
OM131 = qd[31]+OM16;
...
ALPHA132 = ALPHA131+BETA231*dpt[2][48];
ALPHA232 = C32*(ALPHA231+BS531*dpt[2][48])+S32*(ALPHA331+BETA831*dpt[2][48]);
ALPHA332 = C32*(ALPHA331+BETA831*dpt[2][48])-S32*(ALPHA231+BS531*dpt[2][48]);
OM133 = qd[33]+OM132;
...
ALPHA133 = ALPHA132+BETA332*dpt[3][49];
ALPHA233 = C33*(ALPHA232+BETA632*dpt[3][49])+S33*(ALPHA332+BS932*dpt[3][49]);
ALPHA333 = C33*(ALPHA332+BS932*dpt[3][49])-S33*(ALPHA232+BETA632*dpt[3][49]);
...
ALPHA134 = C34*(ALPHA132+BETA332*dpt[3][50])+S34*(ALPHA232+BETA632*dpt[3][50]);
ALPHA234 = C34*(ALPHA232+BETA632*dpt[3][50])-S34*(ALPHA132+BETA332*dpt[3][50]);
ALPHA334 = ALPHA332+BS932*dpt[3][50];
OM135 = qd[35]+OM134;
...
ALPHA135 = ALPHA134+BETA334*dpt[3][53];
ALPHA235 = C35*(ALPHA234+BETA634*dpt[3][53])+S35*(ALPHA334+BS934*dpt[3][53]);
ALPHA335 = C35*(ALPHA334+BS934*dpt[3][53])-S35*(ALPHA234+BETA634*dpt[3][53]);
...
ALPHA136 = C36*(ALPHA135+BETA235*dpt[2][55]+BETA335*dpt[3][55])-S36*(ALPHA335+BETA835*dpt[2][55]+BS935*dpt[3][55]);
ALPHA236 = ALPHA235+BETA635*dpt[3][55]+BS535*dpt[2][55];
ALPHA336 = C36*(ALPHA335+BETA835*dpt[2][55]+BS935*dpt[3][55])+S36*(ALPHA135+BETA235*dpt[2][55]+BETA335*dpt[3][55]);
...
Cq135 = -trq[1][35]+Cq136*C36+Cq336*S36-Fs236*dpt[3][55]+dpt[2][55]*(-Fs136*S36+Fs336*C36);
Cq235 = -trq[2][35]+Cq236+dpt[3][55]*(Fs136*C36+Fs336*S36);
Cq335 = -trq[3][35]-Cq136*S36+Cq336*C36-dpt[2][55]*(Fs136*C36+Fs336*S36);
Fq134 = -frc[1][34]+Fq135;
Fq234 = -frc[2][34]+Fq235*C35-Fq335*S35;
Fq334 = -frc[3][34]+Fq235*S35+Fq335*C35;
Cq134 = -trq[1][34]+Cq135-dpt[3][53]*(Fq235*C35-Fq335*S35);
Cq234 = -trq[2][34]+Cq235*C35-Cq335*S35+Fq135*dpt[3][53];
...
Cq132 = -trq[1][32]+Cq133+Cq134*C34-Cq234*S34-dpt[3][49]*(Fs233*C33-Fs333*S33)-dpt[3][50]*(Fq134*S34+Fq234*C34);
Cq232 = -trq[2][32]+Cq134*S34+Cq233*C33+Cq234*C34-Cq333*S33+Fs133*dpt[3][49]+dpt[3][50]*(Fq134*C34-Fq234*S34);
...
Cq131 = -trq[1][31]+Cq132+dpt[2][48]*(Fq232*S32+Fq332*C32);
Cq231 = -trq[2][31]+Cq232*C32-Cq332*S32;
Cq331 = -trq[3][31]+Cq232*S32+Cq332*C32-Fq132*dpt[2][48];
...
Cq128 = -trq[1][28]+Cq129*C29+Cq329*S29-Fs229*dpt[3][44]+dpt[2][44]*(-Fs129*S29+Fs329*C29);
Cq228 = -trq[2][28]+Cq229+dpt[3][44]*(Fs129*C29+Fs329*S29);
Cq328 = -trq[3][28]-Cq129*S29+Cq329*C29-dpt[2][44]*(Fs129*C29+Fs329*S29);
Fq127 = -frc[1][27]+Fq128;
Fq227 = -frc[2][27]+Fq228*C28-Fq328*S28;
Fq327 = -frc[3][27]+Fq228*S28+Fq328*C28;
Cq127 = -trq[1][27]+Cq128-dpt[3][42]*(Fq228*C28-Fq328*S28);
Cq227 = -trq[2][27]+Cq228*C28-Cq328*S28+Fq128*dpt[3][42];
...
Cq125 = -trq[1][25]+Cq126+Cq127*C27-Cq227*S27-dpt[3][38]*(Fs226*C26-Fs326*S26)-dpt[3][39]*(Fq127*S27+Fq227*C27);
Cq225 = -trq[2][25]+Cq127*S27+Cq226*C26+Cq227*C27-Cq326*S26+Fs126*dpt[3][38]+dpt[3][39]*(Fq127*C27-Fq227*S27);
...
Cq124 = -trq[1][24]+Cq125+dpt[2][37]*(Fq225*S25+Fq325*C25);
Cq224 = -trq[2][24]+Cq225*C25-Cq325*S25;
Cq324 = -trq[3][24]+Cq225*S25+Cq325*C25-Fq125*dpt[2][37];
...
Cq120 = -trq[1][20]+Cq121*C21+Cq321*S21-Fs221*dpt[3][35]+dpt[2][35]*(-Fs121*S21+Fs321*C21);
Cq220 = -trq[2][20]+Cq221+dpt[3][35]*(Fs121*C21+Fs321*S21);
Cq320 = -trq[3][20]-Cq121*S21+Cq321*C21-dpt[2][35]*(Fs121*C21+Fs321*S21);
Fq119 = -frc[1][19]+Fq120;
Fq219 = -frc[2][19]+Fq220*C20-Fq320*S20;
Fq319 = -frc[3][19]+Fq220*S20+Fq320*C20;
Cq119 = -trq[1][19]+Cq120-dpt[3][33]*(Fq220*C20-Fq320*S20);
Cq219 = -trq[2][19]+Cq220*C20-Cq320*S20+Fq120*dpt[3][33];
...
Cq117 = -trq[1][17]+Cq118+Cq119*C19-Cq219*S19-dpt[3][29]*(Fs218*C18-Fs318*S18)-dpt[3][30]*(Fq119*S19+Fq219*C19);
Cq217 = -trq[2][17]+Cq119*S19+Cq218*C18+Cq219*C19-Cq318*S18+Fs118*dpt[3][29]+dpt[3][30]*(Fq119*C19-Fq219*S19);
...
Cq116 = -trq[1][16]+Cq117+dpt[2][28]*(Fq217*S17+Fq317*C17);
Cq216 = -trq[2][16]+Cq217*C17-Cq317*S17;
Cq316 = -trq[3][16]+Cq217*S17+Cq317*C17-Fq117*dpt[2][28];
...
Cq111 = -trq[1][11]+Cq112*C12+Cq312*S12-Fs212*dpt[3][24]+dpt[2][24]*(-Fs112*S12+Fs312*C12);
Cq211 = -trq[2][11]+Cq212+dpt[3][24]*(Fs112*C12+Fs312*S12);
Cq311 = -trq[3][11]-Cq112*S12+Cq312*C12-dpt[2][24]*(Fs112*C12+Fs312*S12);
Fq110 = -frc[1][10]+Fq111;
Fq210 = -frc[2][10]+Fq211*C11-Fq311*S11;
Fq310 = -frc[3][10]+Fq211*S11+Fq311*C11;
Cq110 = -trq[1][10]+Cq111-dpt[3][22]*(Fq211*C11-Fq311*S11);
Cq210 = -trq[2][10]+Cq211*C11-Cq311*S11+Fq111*dpt[3][22];
...
Cq18 = -trq[1][8]+Cq19+Cq110*C10-Cq210*S10-dpt[3][18]*(Fs29*C9-Fs39*S9)-dpt[3][19]*(Fq110*S10+Fq210*C10);
Cq28 = -trq[2][8]+Cq110*S10+Cq210*C10+Cq29*C9-Cq39*S9+Fs19*dpt[3][18]+dpt[3][19]*(Fq110*C10-Fq210*S10);
Cq38 = -trq[3][8]+Cq310+Cq29*S9+Cq39*C9;
Fq17 = -frc[1][7]+Fq18;
Fq27 = -frc[2][7]+Fq28*C8-Fq38*S8;
Fq37 = -frc[3][7]+Fq28*S8+Fq38*C8;
Cq17 = -trq[1][7]+Cq18+dpt[2][17]*(Fq28*S8+Fq38*C8);
Cq27 = -trq[2][7]+Cq28*C8-Cq38*S8;
Cq37 = -trq[3][7]+Cq28*S8+Cq38*C8-Fq18*dpt[2][17];
